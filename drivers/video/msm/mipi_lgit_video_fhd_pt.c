...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	...
	{0x00, 0xC6, 0x01, 0x1A, 0x00, 0x50, 0x48, 0x63,
	 ...
	 0x00, 0x20, 0x00, 0x01},
#elif defined(CONFIG_MACH_APQ8064_GKATT) || defined(CONFIG_MACH_APQ8064_GKOPENHK) || defined (CONFIG_MACH_APQ8064_GKOPENTW) || defined(CONFIG_MACH_APQ8064_GKSHBSG)
	{0x00, 0xDF, 0x01, 0x1A, 0x00, 0x50, 0x48, 0x63,
	 0x40, 0x07, 0x01, 0x00, 0x14, 0x03, 0x00, 0x02,
	 0x00, 0x20, 0x00, 0x01},

#elif defined(CONFIG_MACH_APQ8064_GKU) || defined(CONFIG_MACH_APQ8064_GKKT) || defined(CONFIG_MACH_APQ8064_GKSK) || defined(CONFIG_MACH_APQ8064_GVAR_CMCC) || defined(CONFIG_MACH_APQ8064_AWIFI)
