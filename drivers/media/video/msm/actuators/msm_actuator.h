...
struct msm_actuator_func_tbl {
	...
	int32_t (*actuator_move_focus_manual) (struct msm_actuator_ctrl_t *,
			struct msm_actuator_move_params_t *);// LGE_CHANGE, Manual focus for A-pjt, 2013-07-16, seungmin.hong@lge.com
};
...
struct msm_actuator_ctrl_t {
	...
	uint16_t *step_position_table_manual; // LGE_CHANGE, Manual focus for A-pjt, 2013-07-10, seungmin.hong@lge.com
